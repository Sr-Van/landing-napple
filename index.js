...
const buyAnim = (icon, button, text) => {
...
airpoCont.addEventListener("mouseover", () =>  hoverTextCont(airpoText))

btnHeader.addEventListener("click", () => buyAnim(buyIcon, btnHeader, buyText))
